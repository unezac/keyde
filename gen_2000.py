...
Run: python gen_2000.py > seed_all_sentences.py
"""
...
def generate_sentences():
    ...
    sentences.extend([{"german_text": s[0], "english_translation": s[1], "arabic_translation": s[2], "level": "A1", "difficulty_score": s[3], "category": s[4]} for s in greetings_a1])
    ...
    sentences.extend([{"german_text": s[0], "english_translation": s[1], "arabic_translation": s[2], "level": "A1", "difficulty_score": s[3], "category": s[4]} for s in personal_a1])
    
    print(f"Generated {len(sentences)} sentences so far...")
    return sentences
